          ...
          <div v-else class="space-y-2">
            ...
            >
              ...
              <div class="flex items-center space-x-2">
                ...
                <button v-if="!point.is_default" @click="setDefault(point, 'points')" class="p-1 text-gray-400 hover:text-indigo-600" title="设为默认">
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
async function setDefault(point: EstimatePoint, mode: EstimateMode) {
  try {
