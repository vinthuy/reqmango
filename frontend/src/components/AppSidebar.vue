...
const navItems = computed(() => {
  ...
  return [
    { label: '项目', icon: 'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z', path: '' },
    { label: '路线图', icon: 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l5.447 2.724A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7', path: '/roadmap' },
    { label: 'Initiatives', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6', path: '/initiatives' },
    { label: '分析', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0v-6', path: '/analytics' },
  ...
  >
    ...
    <div v-if="isWorkspaceContext" class="px-2 pt-2">
      ...
      <div v-if="showWorkspaceMenu && !collapsed" class="mt-1 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 z-50">
        <div class="px-3 py-1.5 text-xs text-gray-400 uppercase tracking-wider">工作空间</div>
    ...
    <nav class="flex-1 overflow-y-auto px-2 py-2 space-y-0.5">
      ...
      <template v-if="isWorkspaceContext">
        ...
        <div v-if="!collapsed" class="px-3 pt-3 pb-1">
          <p class="text-xs font-medium text-gray-400 dark:text-gray-500 uppercase tracking-wider">项目</p>
        </div>
