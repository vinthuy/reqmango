...
- Name: workspace-settings-e2e.spec.ts >> Workspace Settings - Integrations >> integrations section renders sub-tabs
- Location: e2e\workspace-settings-e2e.spec.ts:299:3
...
- banner:
  ...
  - navigation:
    - link "项目":
      - /url: /workspace/e2e-settings-e2ews1783254505198
    - link "战略目标":
      - /url: /workspace/e2e-settings-e2ews1783254505198/initiatives
    - link "设置":
      - /url: /workspace/e2e-settings-e2ews1783254505198/settings
...
- main:
  ...
  - main:
    ...
    - button "GitHub"
    - button "Slack"
    - heading "MCP 服务器" [level=2]
    - paragraph: 连接到模型上下文协议服务器以访问 AI 工具
    - button "+ 添加 MCP 服务器"
    - paragraph: No MCP servers configured
    - paragraph: Add an MCP server to enable AI tool access.
```
