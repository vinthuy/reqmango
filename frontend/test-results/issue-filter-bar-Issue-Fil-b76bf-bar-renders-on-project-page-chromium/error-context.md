...
- Name: issue-filter-bar.spec.ts >> Issue Filter Bar >> filter bar renders on project page
- Location: e2e\issue-filter-bar.spec.ts:47:3
...
Locator: locator('.issue-filter-bar input[type="text"]').first()
Expected: visible
Timeout: 10000ms
