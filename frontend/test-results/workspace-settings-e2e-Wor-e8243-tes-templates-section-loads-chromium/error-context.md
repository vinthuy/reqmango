...
- Name: workspace-settings-e2e.spec.ts >> Workspace Settings - Relations & Templates >> templates section loads
- Location: e2e\workspace-settings-e2e.spec.ts:433:3
...
Call log:
  ...
  - waiting for locator('main, .flex-1').first()
    12 × locator resolved to <div class="flex-1"></div>
...
- banner:
  ...
  - navigation:
    - link "项目":
      - /url: /workspace/e2e-settings-e2ews1783254566078
    - link "战略目标":
      - /url: /workspace/e2e-settings-e2ews1783254566078/initiatives
    - link "设置":
      - /url: /workspace/e2e-settings-e2ews1783254566078/settings
...
- main:
  - complementary:
    ...
    - navigation:
      ...
      - button "🧩 插件 0"
  - main:
    - heading "项目模板" [level=1]
    - paragraph: 从类型模板创建可重用的项目结构
    - button "创建模板"
```
