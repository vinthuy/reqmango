...
- Name: workspace-settings-e2e.spec.ts >> Workspace Settings - Custom Fields & Types >> custom fields section loads
- Location: e2e\workspace-settings-e2e.spec.ts:398:3
...
- banner:
  ...
  - navigation:
    - link "项目":
      - /url: /workspace/e2e-settings-e2ews1783254547726
    - link "战略目标":
      - /url: /workspace/e2e-settings-e2ews1783254547726/initiatives
    - link "设置":
      - /url: /workspace/e2e-settings-e2ews1783254547726/settings
...
- main:
  - complementary:
    ...
    - navigation:
      ...
      - button "🧩 插件 0"
  - main:
    - heading "自定义字段" [level=2]
    - paragraph: 定义工作空间中可用的自定义字段（如优先级、版本号等）
    - button "新建字段":
      - img
      - text: 新建字段
    - img
    - paragraph: 暂无自定义字段，点击上方按钮创建
```
