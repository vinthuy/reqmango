...
- Name: workspace-settings-e2e.spec.ts >> Workspace Settings Navigation >> navigate to settings section: Members
...
- banner:
  ...
  - navigation:
    - link "项目":
      - /url: /workspace/e2e-settings-e2ews1783254390686
    - link "战略目标":
      - /url: /workspace/e2e-settings-e2ews1783254390686/initiatives
    - link "设置":
      - /url: /workspace/e2e-settings-e2ews1783254390686/settings
...
- main:
  ...
  - main:
    ...
    - paragraph: e2ews1783254390686@t.com
    - combobox:
      - option "管理员" [selected]
      - option "成员"
      - option "访客"
