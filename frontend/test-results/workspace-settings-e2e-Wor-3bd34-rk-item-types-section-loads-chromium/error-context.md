...
- Name: workspace-settings-e2e.spec.ts >> Workspace Settings - Custom Fields & Types >> work item types section loads
- Location: e2e\workspace-settings-e2e.spec.ts:391:3
...
- banner:
  ...
  - navigation:
    - link "项目":
      - /url: /workspace/e2e-settings-e2ews1783254537847
    - link "战略目标":
      - /url: /workspace/e2e-settings-e2ews1783254537847/initiatives
    - link "设置":
      - /url: /workspace/e2e-settings-e2ews1783254537847/settings
...
- main:
  - complementary:
    ...
    - navigation:
      ...
      - button "🧩 插件 0"
  - main:
    - heading "工作项类型" [level=2]
    - paragraph: 定义工作空间中可用的工作项类型（如 Bug、Story、Task 等）
    - button "新建类型":
      - img
      - text: 新建类型
    - img
    - paragraph: 暂无工作项类型，点击上方按钮创建
```
