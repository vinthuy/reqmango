...
- Name: workspace-settings-e2e.spec.ts >> Workspace Settings Navigation >> navigate to settings section: Types
...
- banner:
  ...
  - navigation:
    - link "项目":
      - /url: /workspace/e2e-settings-e2ews1783254400054
    - link "战略目标":
      - /url: /workspace/e2e-settings-e2ews1783254400054/initiatives
    - link "设置":
      - /url: /workspace/e2e-settings-e2ews1783254400054/settings
