...
- Name: workspace-settings-e2e.spec.ts >> Workspace Settings Navigation >> navigate to settings section: Roles
...
- banner:
  ...
  - navigation:
    - link "项目":
      - /url: /workspace/e2e-settings-e2ews1783254458779
    - link "战略目标":
      - /url: /workspace/e2e-settings-e2ews1783254458779/initiatives
    - link "设置":
      - /url: /workspace/e2e-settings-e2ews1783254458779/settings
