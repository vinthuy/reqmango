...
- Name: workspace-settings-e2e.spec.ts >> Workspace Settings - Members >> members section shows member list with headers
- Location: e2e\workspace-settings-e2e.spec.ts:113:3
...
- banner:
  ...
  - navigation:
    - link "项目":
      - /url: /workspace/e2e-settings-e2ews1783254476698
    - link "战略目标":
      - /url: /workspace/e2e-settings-e2ews1783254476698/initiatives
    - link "设置":
      - /url: /workspace/e2e-settings-e2ews1783254476698/settings
...
- main:
  - complementary:
    ...
    - navigation:
      ...
      - button "🧩 插件 0"
  - main:
    - heading "成员管理" [level=3]
    - button "添加成员":
      - img
      - text: 添加成员
    - text: EW
    - paragraph: E2E WS Settings
    - paragraph: e2ews1783254476698@t.com
    - combobox:
      - option "管理员" [selected]
      - option "成员"
      - option "访客"
