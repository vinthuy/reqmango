...
type AgentEntry struct {
	...
	Capabilities json.RawMessage `gorm:"type:jsonb;not null;default:'[]'" json:"capabilities"` //["triage","planning","review"]
	AgentDef     json.RawMessage `gorm:"type:jsonb;not null" json:"agent_def"` // model, prompt, tools
	...
	Source       string          `gorm:"size:50;default:local" json:"source"` // local, marketplace
