...
**目标�?* �?Claude/Cursor/VS Code �?AI 编程工具直接操作 reqmango
...
- **内容�?*
  - 前置条件（K8s 1.25+, Helm 3.12+, kubectl�?  - 快速开始：`helm install reqmango ./reqmango -f values-prod.yaml`
  - 升级：`helm upgrade reqmango ./reqmango`
  - 卸载：`helm uninstall reqmango`
