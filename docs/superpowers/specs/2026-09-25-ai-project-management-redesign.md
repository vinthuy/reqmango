...
1. 本文作为现行设计基线。  
2. 编写实施计划：`docs/superpowers/plans/2026-09-25-ai-project-management-phase1.md`（任务可勾选）。  
3. 更新 `docs/dev/pipeline-status.md` / `docs/dev/active/README.md` 指向本设计。  
4. 在废止文档文首加 Superseded 指向。
